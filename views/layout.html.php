                ...
                <?php if(isLoggedIn()):?>
                        ...
                        <div class="sub-menu-wrap" id="subMenu">
                            <div class="sub-menu">
                                ...
                                <hr>
                                <a href="/coursework/models/profile.php" class="sub-menu-link">
    ...
    <div class="main-container">
        <main class="main-content">
            <div class="main-content-welcome">
                <?php if(!isLoggedIn() && isset($pageType) && $pageType === 'home-page'):?>
                    <p>Newest Questions</p>
                <?php elseif(isset($pageType) && $pageType === 'profile-page'): ?>My Post
                ...
                <?php if(isset($pageType) && $pageType === 'profile-page'): ?>
                    <div class="profile-card">
                        <div class="profile-header">
                            <img class="profile-avatar" src="/coursework/assets/images/random_pfp/<?= $avatar ?>" alt="User avatar">
                            <div class="profile-names">
                                ...
                                <p class="profile-username">@<?= htmlspecialchars($currentUser['username'] ?? 'anonymous', ENT_QUOTES, 'UTF-8') ?></p>
                            </div>
                        </div>
                        
                        <?php if(!empty($currentUser['bio'])): ?>
                            <p class="profile-bio"><?= htmlspecialchars($currentUser['bio'] ?? '', ENT_QUOTES, 'UTF-8') ?></p>

                        <?php endif; ?>
                        
                        <div class="profile-stats">
                            <div class="stat-item">
                                <span class="stat-value"><?= getUserPostCount($pdo, $_SESSION['user_id']) ?? 0 ?></span>
                                <span class="stat-label">Posts</span>
                            </div>
                            <div class="stat-item">
                                <span class="stat-value"><?= getUserCommentCount($pdo, $_SESSION['user_id']) ?? 0 ?></span>
